...
TEST_F(TestCodecs, DecodeBigEndian_8bits)
{
...
TEST_F(TestCodecs, DecodeBigEndian_chars)
{
#if CHAR_BIT == 8
...
TEST_F(TestCodecs, Encode8bits)
{
    unsigned char outbuffer[1];
    scrutiny::codecs::encode_8_bits_8bits((uint_least8_t)0xABu, outbuffer);
    EXPECT_EQ(outbuffer[0], 0xABu);
}

TEST_F(TestCodecs, EncodeBigEndian_8bits)
{
...
TEST_F(TestCodecs, EncodeBigEndian_char)
{
#if CHAR_BIT == 8
...
TEST_F(TestCodecs, DecodeLittleEndian_8bits)
{
...
TEST_F(TestCodecs, DecodeLittleEndian_char)
{
#if CHAR_BIT == 8

    unsigned char buffer16[2] = { 0x34, 0x12 };
    EXPECT_EQ(scrutiny::codecs::decode_16_bits_little_endian_char(buffer16), 0x1234u);

    unsigned char buffer32[4] = { 0x78, 0x56, 0x34, 0x12 };
    EXPECT_EQ(scrutiny::codecs::decode_32_bits_little_endian_char(buffer32), 0x12345678u);

    unsigned char buffer_float[4] = { 0xda, 0x0f, 0x49, 0x40 };
    EXPECT_EQ(scrutiny::codecs::decode_float_little_endian_char(buffer_float), 3.1415926f);

#if SCRUTINY_SUPPORT_64BITS
    unsigned char buffer64[8] = { 0xf0, 0xde, 0xbc, 0x9a, 0x78, 0x56, 0x34, 0x12 };
    EXPECT_EQ(scrutiny::codecs::decode_64_bits_little_endian_char(buffer64), 0x123456789abcdef0u);
#endif
    ...
    unsigned char buffer32[2] = { 0x5678, 0x1234 };
    EXPECT_EQ(scrutiny::codecs::decode_32_bits_little_endian_char(buffer32), 0x12345678u);

    unsigned char buffer_float[2] = { 0x0fda, 0x4049 };
    EXPECT_EQ(scrutiny::codecs::decode_float_little_endian_char(buffer_float), 3.1415926f);

#if SCRUTINY_SUPPORT_64BITS
    unsigned char buffer64[4] = { 0xdef0, 0x9abc, 0x5678, 0x1234 };
    EXPECT_EQ(scrutiny::codecs::decode_64_bits_little_endian_char(buffer64), 0x123456789abcdef0u);
#endif
...
TEST_F(TestCodecs, EncodeLittleEndian_8bits)
{
...
TEST_F(TestCodecs, EncodeLittleEndian_char)
{
#if CHAR_BIT == 8
    ...
    unsigned char buffer16[2] = { 0x34, 0x12 };
    scrutiny::codecs::encode_16_bits_little_endian_char((uint16_t)0x1234u, outbuffer);
    EXPECT_BUF_EQ(outbuffer, buffer16, sizeof(buffer16));

    unsigned char buffer32[4] = { 0x78, 0x56, 0x34, 0x12 };
    scrutiny::codecs::encode_32_bits_little_endian_char((uint32_t)0x12345678u, outbuffer);
    EXPECT_BUF_EQ(outbuffer, buffer32, sizeof(buffer32));

    unsigned char buffer_float[4] = { 0xda, 0x0f, 0x49, 0x40 };
    scrutiny::codecs::encode_float_little_endian_char(3.1415926f, outbuffer);
    EXPECT_BUF_EQ(outbuffer, buffer_float, sizeof(buffer_float));

#if SCRUTINY_SUPPORT_64BITS
    unsigned char buffer64[8] = { 0xf0, 0xde, 0xbc, 0x9a, 0x78, 0x56, 0x34, 0x12 };
    scrutiny::codecs::encode_64_bits_little_endian_char((uint64_t)0x123456789abcdef0u, outbuffer);
    EXPECT_BUF_EQ(outbuffer, buffer64, sizeof(buffer64));
#endif
