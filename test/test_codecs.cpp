...
TEST_F(TestCodecs, DecodeBigEndian)
{
    ...
    EXPECT_EQ(scrutiny::codecs::decode_16_bits_big_endian(buffer16), 0x1234);

    uint8_t buffer32[4] = {0x12, 0x34, 0x56, 0x78};
    EXPECT_EQ(scrutiny::codecs::decode_32_bits_big_endian(buffer32), 0x12345678);
    ...
    EXPECT_EQ(scrutiny::codecs::decode_64_bits_big_endian(buffer64), 0x123456789abcdef0);
#endif
}
...
TEST_F(TestCodecs, EncodeBigEndian)
{
    ...
    uint8_t buffer16[2] = {0x12, 0x34};
    scrutiny::codecs::encode_16_bits_big_endian(0x1234, outbuffer);
    EXPECT_BUF_EQ(outbuffer, buffer16, sizeof(buffer16));

    uint8_t buffer32[4] = {0x12, 0x34, 0x56, 0x78};
    scrutiny::codecs::encode_32_bits_big_endian(0x12345678, outbuffer);
...
#if SCRUTINY_SUPPORT_64BITS
    uint8_t buffer64[8] = {0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc, 0xde, 0xf0};
    scrutiny::codecs::encode_64_bits_big_endian(0x123456789abcdef0, outbuffer);
...
TEST_F(TestCodecs, DecodeLittleEndian)
{
    ...
    EXPECT_EQ(scrutiny::codecs::decode_16_bits_little_endian(buffer16), 0x1234);

    uint8_t buffer32[4] = {0x78, 0x56, 0x34, 0x12};
    EXPECT_EQ(scrutiny::codecs::decode_32_bits_little_endian(buffer32), 0x12345678);
    ...
    EXPECT_EQ(scrutiny::codecs::decode_64_bits_little_endian(buffer64), 0x123456789abcdef0);
#endif
}
...
TEST_F(TestCodecs, EncodeLittleEndian)
{
    ...
    uint8_t buffer16[2] = {0x34, 0x12};
    scrutiny::codecs::encode_16_bits_little_endian(0x1234, outbuffer);
    EXPECT_BUF_EQ(outbuffer, buffer16, sizeof(buffer16));

    uint8_t buffer32[4] = {0x78, 0x56, 0x34, 0x12};
    scrutiny::codecs::encode_32_bits_little_endian(0x12345678, outbuffer);
    EXPECT_BUF_EQ(outbuffer, buffer32, sizeof(buffer32));
...
#if SCRUTINY_SUPPORT_64BITS
    uint8_t buffer64[8] = {0xf0, 0xde, 0xbc, 0x9a, 0x78, 0x56, 0x34, 0x12};
    scrutiny::codecs::encode_64_bits_little_endian(0x123456789abcdef0, outbuffer);
    EXPECT_BUF_EQ(outbuffer, buffer64, sizeof(buffer64));
#endif
}