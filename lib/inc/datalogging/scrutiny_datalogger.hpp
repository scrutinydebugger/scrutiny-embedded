...
namespace scrutiny
{
    ...
    namespace datalogging
    {
        ...
        public:
            ...
            void init(MainHandler *main_handler, Timebase *timebase, uint8_t *const buffer, buffer_size_t const buffer_sizem, trigger_callback_t trigger_callback = nullptr);
