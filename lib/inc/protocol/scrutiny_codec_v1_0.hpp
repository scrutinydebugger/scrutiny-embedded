...
namespace scrutiny
{
    namespace protocol
    {
        ...
        public:
            ...
            void init(Response* response, const uint32_t max_size, RpvReadCallback cb);
            void write(const RuntimePublishedValue* rpv);
            inline bool overflow() { return m_overflow; };
            void reset();
        ...
        protected:
            ...
            RpvReadCallback m_read_callback;
        };
        ...
        public:
            ...
            ReadRPVResponseEncoder* encode_response_memory_control_read_rpv(Response* response, const uint32_t max_size, RpvReadCallback read_cb);
