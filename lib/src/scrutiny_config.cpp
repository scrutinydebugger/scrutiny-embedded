...
namespace scrutiny
{
    ...
    void Config::set_buffers(unsigned char *rx_buffer, uint16_t const rx_buffer_size, unsigned char *tx_buffer, uint16_t const tx_buffer_size)
    {
    ...
    {
        for (uint_least8_t i = 0; i < m_loop_count; i++)
        {
