...
void file4SetValues()
{
    ...
    file4classB_array[1].some_bool = false;
    file4classB_array[1].array_of_A2[2][0].xxx = 0xdeadbeef + 3;
    file4classB_array[1].array_of_A2[2][0].yyy[0][0] = 0x10001111 + 3;
    file4classB_array[1].array_of_A2[2][0].yyy[0][1] = 0x20002222 + 3;
    file4classB_array[1].array_of_A2[2][0].yyy[0][2] = 0x30003333 + 3;
    file4classB_array[1].array_of_A2[2][0].yyy[1][2] = 0x40004444 + 3;
    file4classB_array[1].array_of_A2[2][0].zzz[0][0][0] = 0x5566 + 3;
    file4classB_array[1].array_of_A2[2][0].zzz[1][2][3] = 0x6789 + 3;
    file4classB_array[1].array_of_A2[2][0].A2enum = File4NamespaceA1::File4EnumA::YYY;
